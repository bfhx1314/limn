...
public class BeforeTest implements Runnable {
	...
	//本地化的RunLog
	public BeforeTest(HashMap<String, String> map) {
		testParameter = map;
		update = false;
		beforeTest();
	}
	...
	//连接服务器 RunLog
	public BeforeTest(HashMap<String, String> map,Socket socket) {
...
//			resultPath = Variable.resolve("[UploadServer_Result_Path]");
	...
	public static void setKeyWordDriver(KeyWordDriver kwd){
		keyWordDriver = kwd;
	}
